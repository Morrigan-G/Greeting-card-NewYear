...
private pages: Page[] = [
  ...
  {
    lines: [
  'Я сделал эту открытку,',
  'чтоб она всегда была с тобой,',
  'Неизвестно, что принесёт новый год,',
  'Но этот был наполнен злом и добротой.',
  'Желаю, чтоб было меньше забот.',
  'На небе ночном все звёзды ярки,',
  'Но лишь одна из них приносит подарки.',
  '..................................',
  'Пусть она укажет верный путь в ночи,',
  'Согреет светом в нужный час,',
  'Пусть сбудется всё, о чём ты молчишь,',
  'И счастье будет близко сейчас.',
  '..................................',
  'Пусть дом наполнят смех и тепло,',
  'А сердце — любовь и покой,',
  'Пусть новый год подарит добро',
  'И сохранит всё важное рядом тобой.'
],
    backgroundColor: 'linear-gradient(135deg, #EEF2FF 0%, #EDE9FE 100%)',
    type: 'accumulative'
  },
  {
    title: 'Я знаю твои желания...',
  backgroundColor: 'linear-gradient(135deg, #C7D2FE 0%, #EDE9FE 100%)',
  type: 'title'
  },
  {
